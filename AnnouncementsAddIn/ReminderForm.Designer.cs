namespace AnnouncementsAddIn
	...
	partial class ReminderForm
		...
		private void InitializeComponent()
			...
			// rtbReminder
			// 
			this.rtbReminder.AcceptsTab = true;
			this.rtbReminder.DetectUrls = false;
			this.rtbReminder.Location = new System.Drawing.Point(3, 28);
			this.rtbReminder.Name = "rtbReminder";
			this.rtbReminder.Size = new System.Drawing.Size(279, 121);
			this.rtbReminder.TabIndex = 2;
			this.rtbReminder.Text = "";
			this.rtbReminder.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.rtbReminder_KeyPress);
			// 
			// btnOK
			// 
			...
			// lblDate
			// 
			this.lblDate.Location = new System.Drawing.Point(39, 9);
